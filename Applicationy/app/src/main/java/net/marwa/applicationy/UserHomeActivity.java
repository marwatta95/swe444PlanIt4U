...
public class UserHomeActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        makeMyParty=(Button) findViewById(R.id.makeMyParty);
        makeMyParty.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                startActivity(new Intent(UserHomeActivity.this, UserFirstActivity.class));
